...
// Always ask whenCode Forge tries to edit its own config files
 ...
 * This is a per-user temporary directory used byCode Forge for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally byCode Forge)
