...
export const DESCRIPTION = 'Get or setCode Forge configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or setCode Forge configuration settings.

  View or changeCode Forge settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
